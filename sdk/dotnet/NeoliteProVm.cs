...
namespace Shirasakaren.Biznetgio
{
    ...
    public partial class NeoliteProVm : global::Pulumi.CustomResource
    {
        ...
        public NeoliteProVm(string name, NeoliteProVmArgs args, CustomResourceOptions? options = null)
            : base("biznetgio:index:NeoliteProVm", name, args ?? new NeoliteProVmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NeoliteProVm(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("biznetgio:index:NeoliteProVm", name, null, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static NeoliteProVm Get(string name, Input<string> id, CustomResourceOptions? options = null)
        {
            return new NeoliteProVm(name, id, options);
        }
    }

    public sealed class NeoliteProVmArgs : global::Pulumi.ResourceArgs
    {
        ...
        public static new NeoliteProVmArgs Empty => new NeoliteProVmArgs();
    }
}

...
class ObjectStorageCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] active: Whether the credential is enabled. Set false to disable without deleting. Defaults to true.
        """
...
@pulumi.type_token("biznetgio:index:ObjectStorageCredential")
class ObjectStorageCredential(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ObjectStorageCredential resource with the given unique name, props, and options.
    ...
    def _internal_init(__self__,
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["accessKey", "raw", "secretKey"])
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ObjectStorageCredential':
        """

...
class NeoliteProDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] neolite_account_id: Account id VM NEO Lite Pro tempat disk dipasang.
        :param pulumi.Input[_builtins.int] product_id: Product id disk dari endpoint `/neolite-pros/disks/products`.
        ...
        :param pulumi.Input[_builtins.int] size: Ukuran disk (GB). Default 30 (minimal product disk pro). Cuma bisa naik, bukan turun.
        """

...
public final class ObjectStorageObjectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param content Inline content to upload. Exactly one of `source`/`content` required.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param source Path to the local file to upload. Exactly one of `source`/`content` required.
         * 
         * @return builder
         * 
         */

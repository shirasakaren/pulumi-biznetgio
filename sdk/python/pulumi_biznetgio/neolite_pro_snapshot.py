...
__all__ = ['NeoliteProSnapshotArgs', 'NeoliteProSnapshot']

@pulumi.input_type
class NeoliteProSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] neolite_account_id: Account id of the NEO Lite Pro VM being snapshotted.
...
@pulumi.type_token("biznetgio:index:NeoliteProSnapshot")
class NeoliteProSnapshot(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a NeoliteProSnapshot resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NeoliteProSnapshotArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NeoliteProSnapshotArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NeoliteProSnapshotArgs.__new__(NeoliteProSnapshotArgs)
        ...
        super(NeoliteProSnapshot, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'NeoliteProSnapshot':
        """
        ...
        __props__.__dict__["status"] = None
        return NeoliteProSnapshot(resource_name, opts=opts, __props__=__props__)

...
public final class ObjectStorageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Quota in GB. Defaults to 10. Can only be increased (counted as an add-on to the previous quota).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param quota Quota in GB. Defaults to 10. Can only be increased (counted as an add-on to the previous quota).
         * 
         * @return builder
         * 
         */

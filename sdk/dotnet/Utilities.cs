...
namespace Shirasakaren.Biznetgio
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/shirasakaren/pulumi-biznetgio";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Shirasakaren.Biznetgio.version.txt");
    ...
    internal sealed class BiznetgioResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BiznetgioResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
